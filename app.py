...
# Reads from environment variables; falls back to the local replica.my.conf
# credentials for development.
_DB_USER = os.environ.get("DEPLOYR_DB_USER", "liege")
_DB_PASS = os.environ.get("DEPLOYR_DB_PASS", "rihaan1810")
...
def init_db_command():
    ...
    import db as _db
    from routes.tools import tools_bp as _bp
...
if __name__ == "__main__":
    ...
    # Initialise DB (connectivity check + seed) only when running the server.
